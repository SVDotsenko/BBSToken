...
contract BBSTokenERC223 is usingOraclize, Ownable, RefundVault, BurnableToken, Standard223Token
{
    string public constant name = "BBSTokenERC223";
    string public constant symbol = "BBS_ERC223";
  ...
  function BBSTokenERC223() public payable {
